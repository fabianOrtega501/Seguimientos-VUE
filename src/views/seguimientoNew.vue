        ...
        <div class="card">
          ...
          <div class="card-body">
            <form v-on:submit="guardar">
              ...
              <div class="input-group mb-3">
                <span class="input-group-text"><i class="fa-solid fa-user"></i></span>
                <input type="text" v-model="Fecha" id="Fecha" placeholder="Fecha Actual YYYY-MM-DD" requeride maxlength="50" class="form-control">
              </div>
              <div class="input-group mb-3">
                <span class="input-group-text"><i class="fa-solid fa-user"></i></span>
              ...
              <div class="input-group mb-3">
                <span class="input-group-text"><i class="fa-solid fa-user"></i></span>
                <input type="text" v-model="fecha_proximo_seguimiento" id="fecha_proximo_seguimiento" placeholder="Proximo Seguimiento" requeride maxlength="50" class="form-control">
              </div>
  ...
  export default{
    data(){
      return{
        ...
        url:'http://localhost/cursos/pruebaCrud/public/api/v1/seguimientos',
        cargando:false
      }
    },
    methods:{
