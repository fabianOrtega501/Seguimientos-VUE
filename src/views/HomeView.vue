...
<script>
  ...
  export default{
    ...
    methods:{
      getSeguimientos(){
        this.cargando = true;
        axios.get('http://localhost/cursos/pruebaCrud/public/api/v1/seguimientos').then(
          res => {
      ...
      eliminar(id){
      confirmar('http://localhost/cursos/pruebaCrud/public/api/v1/seguimientos/',id,'Eliminar registro', 'Confirmacion de eliminacion');
      this.cargando = false;
      }
    }    
  }
